...
import 'package:e_triad/src/presentation/home_presentation_view/sub_views/new_arrival_product_view_all.dart';
...
class _NewArrivalsSectionState extends State<NewArrivalsSection> {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocListener(
      ...
      child: BlocBuilder<NewArrivalsCubit, ProductState>(
          ...
          return BlocBuilder<WishlistCubit, WishlistState>(
            builder: (context, wishlistState) {
              ...
              return switch (productState) {
                ...
                StateFetchedNewArrivals(:final newArrivals) => ProductSection(
                  title: 'New Arrivals',
                  products: newArrivals,
    
                  onViewAll:
                      () => context.push(NewArrivalProductViewAll.path),
